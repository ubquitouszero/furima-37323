class Order
  ...
  def save
    ...
    # 住所を保存する
    DeliveryInfo.create(postal_code: postal_code, prefecture_id: prefecture_id, addresses: addresses, city: city, building: building, phone_number: phone_number, sales_info_id: sales_info.id)
  end
